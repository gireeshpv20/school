...
function ltrFn() {
    ...
    document.querySelector("#style")?.setAttribute("href", "../school/public/assets/plugins/bootstrap/css/bootstrap.min.css");
...
function rtlFn() {
    ...
    document.querySelector("#style")?.setAttribute("href", "../school/public/assets/plugins/bootstrap/css/bootstrap.rtl.min.css");
    var carousel = $('.owl-carousel');
    $.each(carousel, function (index, element) {
        // element == this
        var carouselData = $(element).data('owl.carousel');
...
function transparentBgColor() {
    ...
    localStorage.removeItem("solicHeader", 'gradient');
    localStorage.removeItem("solicMenu", 'light');
    localStorage.removeItem("solicMenu", 'gradient');
    localStorage.removeItem("solicMenu", 'color')
}
...
function names() {
    ...
    if (document.querySelector('#radar-multiple') !== null) {
        radarChart();
    }
    ...
    if (document.querySelector('#widgetChart1') !== null) {
        widgetChart1(myVarVal);
    }
    if (document.querySelector('#retunchart') !== null) {
        returnItens();
    }
    if (document.querySelector('#line-graph1') !== null) {
        linegraph();
    }
    if (document.querySelector('#machines') !== null) {
        machines();
    }
    if (document.querySelector('#bouncerate') !== null) {
        bouncerate(myVarVal);
    }
    if (document.querySelector('#analytic') !== null) {
        analyticsChart();
    }
    if (document.querySelector('#Profits-circle') !== null) {
        Profits(myVarVal);
    }
    ...
    if (document.querySelector('#category1') !== null) {
        category(myVarVal);
    }
    if (document.querySelector('#logistics1') !== null) {
        logistics(myVarVal);
    }
    if (document.querySelector('#echart-2') !== null) {
        index5(myVarVal);
    }
