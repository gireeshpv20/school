								...
								<div class="card">
									<div class="card-header">
										...
										<div class="card-options">
                                            <div class="btn-group">
                                                <a class="btn btn-success dropdown-toggle" href="javascript:;"> Add Student</a>
                                            </div>
                                        </div>
									</div>
									<div class="card-body">
            ...
            <div class="modal-body pd-20">
				...
				<table class="table table-bordered mb-0 text-dark">
					<tbody>
						...
						<tr class="border-bottom">
							<td>Image</td>
							<td colspan="3"><img src="<?= esc($group['imageUrl']) ?>"></td>
						</tr>
						</tbody>
    </table>
</div>
        ...
        <div class="modal-content ">
            ...
            <table class="table text-nowrap border text-md-nowrap mb-0 text-dark">
				...
				<tbody>
                    ...
                    <tr>
                        <td>Class No</td>
                        <td><input class="form-control" name="classno" value="<?= esc($group['classno']) ?>" required></td>
                    </tr>
                    <tr>
                        <td>School</td>
                        <td>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content ">
            ...
            <table class="table text-nowrap border text-md-nowrap mb-0 text-dark">
				...
				<tbody>
                        <td>School</td>
                        <td><input class="form-control" name="school" value="<?= esc($group['schoolname']) ?>" required readOnly></td>
                            <!-- <select name="school" class="form-control form-select" required>
								<option value="">Choose School</option>
								<option value="CGHSS" <?= esc($group['schoolname'])=='CGHSS' ? 'selected' : '' ?>>CGHSS</option>
							</select>
